...
export default function Header() {
    ...
    return (
        <header className='z-[999] relative'>
            ...
            <motion.div
                className='fixed top-0 left-1/2 h-[3.5rem] -translate-x-1/2 w-full rounded-none border-white border-opacity-40 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] sm:w-[20rem] sm:rounded-full bg-gray-950 border-black/40 bg-opacity-75'
                    ...
                    {links.map(link => (
                        ...
                        >
                            <Link
                                ...
                                className={clsx('flex w-full items-center justify-center p-3 hover:text-gray-500 transition', {
